...
class RedPackService extends Request
{
    /**
     * 给指定用户发红包
     ...
     * @throws Exception
     */
    public function send($openid, $money, $actName = '抢红包活动', $sendName = '商家', $remark = '祝您生活愉快', $wishing = '恭喜发财')
    {
        ...
        */
        ...
        if ("SUCCESS" === "$responseObj->result_code") {
