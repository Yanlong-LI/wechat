...
class PayService extends Api
{
     ...
     */
    public static function createJsBizPackage(App $app, $openid, $totalFee, $outTradeNo, $orderName, $notifyUrl, $timestamp)
    {
    ...
    public static function getConfig()
    {
        return array(
            ...
            'key' => Kernel::getConfig('apiecret'),//https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
        );
    }
